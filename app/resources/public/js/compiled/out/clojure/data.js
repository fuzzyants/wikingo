...
return cljs.core.reduce.call(null,(function (result,p__26370){
var vec__26371 = p__26370;
var k = cljs.core.nth.call(null,vec__26371,(0),null);
var v = cljs.core.nth.call(null,vec__26371,(1),null);
...
var vec__26373 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__26373,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__26373,(1),null);
var ab = cljs.core.nth.call(null,vec__26373,(2),null);
 ...
 */
clojure.data.EqualityPartition = (function (){var obj26378 = {};
return obj26378;
})();
 ...
 * Implementation detail. Subject to change.
 */
clojure.data.Diff = (function (){var obj26380 = {};
return obj26380;
})();
...
if((function (){var G__26381 = x;
if(G__26381){
var bit__18834__auto__ = (G__26381.cljs$lang$protocol_mask$partition0$ & (1024));
if((bit__18834__auto__) || (G__26381.cljs$core$IMap$)){
return true;
} else {
if((!G__26381.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IMap,G__26381);
} else {
return false;
}
}
...
if((function (){var G__26382 = x;
if(G__26382){
var bit__18834__auto__ = (G__26382.cljs$lang$protocol_mask$partition0$ & (4096));
if((bit__18834__auto__) || (G__26382.cljs$core$ISet$)){
return true;
} else {
if((!G__26382.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISet,G__26382);
} else {
return false;
}
}
...
if((function (){var G__26383 = x;
if(G__26383){
var bit__18834__auto__ = (G__26383.cljs$lang$protocol_mask$partition0$ & (16777216));
if((bit__18834__auto__) || (G__26383.cljs$core$ISequential$)){
return true;
} else {
if((!G__26383.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.ISequential,G__26383);
} else {
return false;
}
}
...
return (function (){var G__26384 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__26384) {
case "map":
...
//# sourceMappingURL=data.js.map?rel=1443194339302