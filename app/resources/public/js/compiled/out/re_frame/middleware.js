...
if(!((function (){var G__26355 = app_db;
if(G__26355){
...
return G__26355.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__26355.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__26355);
} else {
return false;
}
}
...
while (G__26360__i < G__26360__a.length) {G__26360__a[G__26360__i] = arguments[G__26360__i + 0]; ++G__26360__i;}
  args = new cljs.core.IndexedSeq(G__26360__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__26361){
var args = cljs.core.seq(arglist__26361);
...
return cljs.core.get_in.call(null,new_db,p1__26362_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__26363_SHARP_){
return cljs.core.get_in.call(null,db,p1__26363_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__26364__i = 0, G__26364__a = new Array(arguments.length -  2);
while (G__26364__i < G__26364__a.length) {G__26364__a[G__26364__i] = arguments[G__26364__i + 2]; ++G__26364__i;}
  in_paths = new cljs.core.IndexedSeq(G__26364__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__26365){
var f = cljs.core.first(arglist__26365);
arglist__26365 = cljs.core.next(arglist__26365);
var out_path = cljs.core.first(arglist__26365);
var in_paths = cljs.core.rest(arglist__26365);
...
//# sourceMappingURL=middleware.js.map?rel=1443194339195