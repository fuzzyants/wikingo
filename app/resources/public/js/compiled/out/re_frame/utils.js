...
re_frame.utils.default_loggers = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"log","log",-1595516004),(function (p1__26474_SHARP_){
return console.log(p1__26474_SHARP_);
}),new cljs.core.Keyword(null,"warn","warn",-436710552),(function (p1__26475_SHARP_){
return console.warn(p1__26475_SHARP_);
}),new cljs.core.Keyword(null,"error","error",-978969032),(function (p1__26476_SHARP_){
return console.error(p1__26476_SHARP_);
}),new cljs.core.Keyword(null,"group","group",582596132),(function (p1__26477_SHARP_){
if(cljs.core.truth_(console.group())){
return console.group(p1__26477_SHARP_);
} else {
return console.log(p1__26477_SHARP_);
}
...
re_frame.utils.log.cljs$lang$applyTo = (function (seq26478){
return re_frame.utils.log.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26478));
});
...
re_frame.utils.warn.cljs$lang$applyTo = (function (seq26479){
return re_frame.utils.warn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26479));
});
...
re_frame.utils.group.cljs$lang$applyTo = (function (seq26480){
return re_frame.utils.group.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26480));
});
...
re_frame.utils.groupEnd.cljs$lang$applyTo = (function (seq26481){
return re_frame.utils.groupEnd.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26481));
});
...
re_frame.utils.error.cljs$lang$applyTo = (function (seq26482){
return re_frame.utils.error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26482));
});
...
//# sourceMappingURL=utils.js.map?rel=1443194339589