...
return re_com.validate.log_error.cljs$core$IFn$_invoke$arity$variadic(argseq__19200__auto__);
});
...
re_com.validate.log_error.cljs$lang$applyTo = (function (seq29261){
return re_com.validate.log_error.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29261));
});
/**
...
var argseq__19200__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return re_com.validate.log_warning.cljs$core$IFn$_invoke$arity$variadic(argseq__19200__auto__);
});
...
re_com.validate.log_warning.cljs$lang$applyTo = (function (seq29262){
return re_com.validate.log_warning.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq29262));
});
...
var or__18160__auto__ = clojure.set.superset_QMARK_.call(null,defined_args,passed_args);
...
var or__18160__auto__ = clojure.set.superset_QMARK_.call(null,passed_args,required_args);
if(cljs.core.truth_(or__18160__auto__)){
return or__18160__auto__;
} else {
...
var validate_arg = (function (p__29265){
var vec__29266 = p__29265;
var _ = cljs.core.nth.call(null,vec__29266,(0),null);
var v_arg_def = cljs.core.nth.call(null,vec__29266,(1),null);
...
var log_msg_base = ((function (arg_name,arg_val,required_QMARK_,validate_result,vec__29266,_,v_arg_def){
return (function (){
...
});})(arg_name,arg_val,required_QMARK_,validate_result,vec__29266,_,v_arg_def))
;
...
return re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__19200__auto__);
});
...
var and__18148__auto__ = re_com.validate.arg_names_valid_QMARK_.call(null,new cljs.core.Keyword(null,"arg-names","arg-names",1632831252).cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys);
if(cljs.core.truth_(and__18148__auto__)){
var and__18148__auto____$1 = re_com.validate.required_args_passed_QMARK_.call(null,new cljs.core.Keyword(null,"required-args","required-args",1225806985).cljs$core$IFn$_invoke$arity$1(arg_defs),passed_arg_keys);
...
re_com.validate.validate_args.cljs$lang$applyTo = (function (seq29267){
var G__29268 = cljs.core.first.call(null,seq29267);
var seq29267__$1 = cljs.core.next.call(null,seq29267);
var G__29269 = cljs.core.first.call(null,seq29267__$1);
var seq29267__$2 = cljs.core.next.call(null,seq29267__$1);
return re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(G__29268,G__29269,seq29267__$2);
});
...
var or__18160__auto__ = cljs.core.not_EQ_.call(null,cljs.core.some.call(null,cljs.core.PersistentHashSet.fromArray([arg__$1],true),valid_set),null);
...
return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991)], null),cljs.core.interpose.call(null,", ",cljs.core.map.call(null,(function (p1__29270_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"code","code",1586293142),[cljs.core.str(p1__29270_SHARP_)].join('')],null));
}),codes)));
});
...
var arg__$1 = re_com.util.deref_or_value.call(null,arg);
var and__18148__auto__ = cljs.core.map_QMARK_.call(null,arg__$1);
if(and__18148__auto__){
var arg_keys = cljs.core.keys.call(null,arg__$1);
var or__18160__auto__ = clojure.set.superset_QMARK_.call(null,re_com.validate.css_styles,arg_keys);
if(cljs.core.truth_(or__18160__auto__)){
return or__18160__auto__;
} else {
...
return (cljs.core._EQ_.call(null,attr__$1.indexOf(p1__29271_SHARP_),(0))) && ((cljs.core.count.call(null,attr__$1) > cljs.core.count.call(null,p1__29271_SHARP_)));
});})(attr__$1))
;
...
return [cljs.core.str(p1__29272_SHARP_),cljs.core.str("-")].join('');
});})(attr__$1,ext_QMARK_))
...
return cljs.core.remove.call(null,(function (p1__29273_SHARP_){
var or__18160__auto__ = re_com.validate.html_attrs.call(null,p1__29273_SHARP_);
if(cljs.core.truth_(or__18160__auto__)){
return or__18160__auto__;
} else {
return re_com.validate.extension_attribute_QMARK_.call(null,p1__29273_SHARP_);
}
}),attrs);
});
/**
...
var or__18160__auto__ = (result == null);
if(or__18160__auto__){
return or__18160__auto__;
} else {
...
//# sourceMappingURL=validate.js.map?rel=1443194341815